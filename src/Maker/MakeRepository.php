 ...
 */
final class MakeRepository extends AbstractMaker implements InputAwareMakerInterface
{
    private $fileManager;
    ...
    public function configureCommand(Command $command, InputConfiguration $inputConf)
    {
        $command
            ...
            ->addArgument('name', InputArgument::OPTIONAL, sprintf('Class name of the entity to create or update repository (e.g. <fg=yellow>%s</>)', Str::asClassName(Str::getRandomTerm())))
            ->setHelp(file_get_contents(__DIR__.'/../Resources/help/MakeRepository.txt'))
        ;
    ...
    public function interact(InputInterface $input, ConsoleStyle $io, Command $command)
    {
        ...
        $question = $this->createRepositoryClassQuestion($argument->getDescription());
    ...
    private function createRepositoryClassQuestion(string $questionText): Question
    {
